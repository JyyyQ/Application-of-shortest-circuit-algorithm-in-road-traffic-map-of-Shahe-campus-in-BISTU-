# -*- coding: utf-8 -*-
"""
Created on Fri Apr 23 12:42:31 2021

@author: hp
"""
from bellman_ford2 import bellman_ford
from bellman_ford2 import mistake
from bellman_ford2 import Route_print
from bellman_ford2 import single_get_path
import cv2
...
#bellman_ford2.mistake(graph,d)
#bellman_ford2.Route_print(pre,graph,a)
#bellman_ford2.single_get_path(pre, end)
if __name__=='__main__':
    ...
    d,pre = bellman_ford(g,str(z))
    if mistake(g,d)==-1:
        print("图中存在负权环")
    else:
        Route_print(pre,g,str(z),d)
       
    path = single_get_path(pre,str(x),str(z))
  #  print(path)
    print('最短路径：',end='')
    ...
    print('走路预算时间：',end='')
    b=d[str(x)]/2.9*1.1/60
    e=d[str(x)]/2.9*1.1%60
    print(int(b),'分钟',end='')
 ...
 #   print('最短路的坐标路径：',w)
  ...
  #  cv2.namedWindow("image")
   ...
   # cv2.imshow("image", img)
    #cv2.waitKey(0)
    cv2.imwrite("./bellman_ford_route.jpg", img, [int(cv2.IMWRITE_JPEG_QUALITY), 100]) 
    im = Image.open('bellman_ford_route.jpg')
    im.show()