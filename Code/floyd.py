# -*- coding: utf-8 -*-
"""
Created on Mon Mar 22 15:34:54 2021
...
def print_single_path(i,j,path_list,parents):
   # a=int(input("请输入起点：")
   if i !=j:
       print_single_path(i,parents[i][j],path_list,parents)
  # print('->',j,end='')
   path_list.append(j)
   return path_list
def turn(graph):
...
if __name__=='__main__':
    ...
    g={
            ...
            '12':{'11':581.5,'13':223.7,'44':254.2,'257':106,'258':126.1,'262':389.9,'45':267,'47':194.2},
            ...
            '23':{'27':314,'24':1166,'44':152.3,'186':126.3,'134':23.1,'23':196},
            ...
            '177':{'178':357,'200':83.4},
            '178':{'177':357,'173':156.1,'216':276.1},
            '179':{},
            ...
            '217':{'29':166.1,'34':146.1,'178':276.1},
            ...
            '262':{'11':195.2,'12':389.8,'45':133.8},
            '263':{'264':155},
    ...
    b=input('请输入终点：')
    path_list=[]
    print_single_path(int(a),int(b),path_list,parents)
    print('\n')
    print(path_list)
